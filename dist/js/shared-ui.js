...
(function ($) {
  ...
  SUI.suiCodeSnippet = function () {
    ...
    $('.sui-2-12-27 .sui-code-snippet:not(.sui-no-copy)').each(function () {
...
(function ($) {
  ...
  if (0 !== $('.sui-2-12-27 .sui-tree').length) {
    $('.sui-2-12-27 .sui-tree').each(function () {
...
(function ($) {
  ...
  SUI.upload = function () {
    $('.sui-2-12-27 .sui-upload-group input[type="file"]').on('change', function (e) {
    ...
    if ($('.sui-2-12-27 .sui-file-upload').length) {
      // This will trigger on file change. 
      $('.sui-2-12-27 .sui-file-browser input[type="file"]').on('change', function () {
      ...
      $('.sui-2-12-27 .sui-file-browser .sui-upload-button').on('click', function () {
        selectFile($(this));
      });

      // This will trigger when user wants to remove the selected upload file
      $('.sui-2-12-27 .sui-file-upload [aria-label="Remove file"]').on('click', function () {
        removeFile($(this));
      });

      // This will trigger reupload of file
      $('.sui-2-12-27 .sui-file-browser .sui-upload-image').on('click', function () {
        selectFile($(this));
      });
      ...
      var uploadArea = $('.sui-2-12-27 .sui-upload-button');
      if (isAdvancedUpload) {
