...
( function( $ ) {
    ...
    $( document ).ready( function() {
        ...
        $( '.sui-2-1-8 .sui-accordion' ).each( function() {
...
( function( $ ) {
	...
	$( '.sui-2-1-8 .sui-code-snippet:not(.sui-no-copy)' ).each( function( i ) {
...
( function( $ ) {
	...
	SUI.linkDropdown = function() {
		...
		function closeAllDropdowns( $except ) {
			var $dropdowns = $( '.sui-2-1-8 .sui-dropdown' );
...
( function( $ ) {
	...
	$( '.sui-2-1-8 .sui-notice-top:not(.sui-can-dismiss, .sui-cant-dismiss)' ).delay( 3000 ).slideUp( 'slow' );

	$( '.sui-2-1-8 .sui-notice-dismiss' ).click( function( e ) {
		e.preventDefault();
...
( function( $ ) {
	...
	SUI.showHidePassword = function() {
		...
		$( '.sui-2-1-8 .sui-password-group' ).each( function() {
			var $this = $( this ),
...
( function( $ ) {
	...
	$( '.sui-2-1-8 .sui-circle-score' ).each( function() {
...
( function( $ ) {
	...
	$( '.sui-2-1-8 select' ).each( function() {
		SUI.suiSelect( this );
	});
...
( function( $ ) {
	...
	$( '.sui-2-1-8 .sui-tabs' ).each( function() {
		SUI.suiTabs( this );
	});
...
( function( $ ) {
	...
	SUI.upload = function() {
		...
		$( '.sui-2-1-8 .sui-upload-group input[type="file"]' ).on( 'change', function( e ) {
