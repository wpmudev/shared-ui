...
(function ($) {
  ...
  if (0 !== $('.sui-2-13-1 .sui-accordion').length) {
    $('.sui-2-13-1 .sui-accordion').each(function () {
...
(function ($) {
  ...
  SUI.suiCodeSnippet = function () {
    ...
    $('.sui-2-13-1 .sui-code-snippet:not(.sui-no-copy)').each(function () {
...
(function ($) {
  ...
  $('.sui-2-13-1 .sui-slider').each(function () {
...
(function ($) {
  ...
  SUI.showHidePassword = function () {
    $('.sui-2-13-1 .sui-form-field').each(function () {
      var $this = $(this);
...
(function ($) {
  ...
  $('.sui-2-13-1 .sui-reviews').each(function () {
    var review = $(this);
    $.ajax({
...
(function ($) {
  ...
  $('.sui-2-13-1 .sui-circle-score').each(function () {
...
(function ($) {
  ...
  SUI.select.init = function (select) {
    var getParent = select.closest('.sui-modal-content'),
        ...
        selectParent = getParent.length ? $('#' + getParentId) : $('.sui-2-13-1'),
...
(function ($) {
  ...
  $('.sui-2-13-1 .sui-side-tabs label.sui-tab-item input').each(function () {
    SUI.sideTabs(this);
  });
})(jQuery);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
(function ($) {
  ...
  if (0 !== $('.sui-2-13-1 .sui-tabs').length) {
    // Support tabs new markup.
    SUI.tabs(); // Support legacy tabs.

    SUI.suiTabs();
    $('.sui-2-13-1 .sui-tabs-navigation').each(function () {
...
(function ($) {
  ...
  if (0 !== $('.sui-2-13-1 .sui-tree').length) {
    $('.sui-2-13-1 .sui-tree').each(function () {
...
(function ($) {
  ...
  SUI.upload = function () {
    $('.sui-2-13-1 .sui-upload-group input[type="file"]').on('change', function (e) {
    ...
    if ($('.sui-2-13-1 .sui-file-upload').length) {
      // This will trigger on file change. 
      $('.sui-2-13-1 .sui-file-browser input[type="file"]').on('change', function () {
      ...
      $('.sui-2-13-1 .sui-file-browser .sui-upload-button').on('click', function () {
        selectFile($(this));
      }); // This will trigger when user wants to remove the selected upload file

      $('.sui-2-13-1 .sui-file-upload [aria-label="Remove file"]').on('click', function () {
        removeFile($(this));
      }); // This will trigger reupload of file

      $('.sui-2-13-1 .sui-file-browser .sui-upload-image').on('click', function () {
        selectFile($(this));
      ...
      var uploadArea = $('.sui-2-13-1 .sui-upload-button');
