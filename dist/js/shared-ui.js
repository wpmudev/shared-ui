...
( function( $ ) {
	...
	if ( 0 !== $( '.sui-2-3-28 .sui-accordion' ).length ) {

		$( '.sui-2-3-28 .sui-accordion' ).each( function() {
...
( function( $ ) {
    ...
    SUI.suiCodeSnippet = function( ) {
        ...
        $( '.sui-2-3-28 .sui-code-snippet:not(.sui-no-copy)' ).each( function() {
...
( function( $ ) {
	...
	SUI.linkDropdown = function() {
		...
		function closeAllDropdowns( $except ) {
			...
			var $dropdowns = $( '.sui-2-3-28 .sui-dropdown' );
		...
		$( 'body' ).mouseup( function( e ) {
			...
			var $anchor = $( '.sui-2-3-28 .sui-dropdown-anchor' );
...
( function( $ ) {
	...
	document.addEventListener( 'DOMContentLoaded', function() {
		...
		$( '.sui-2-3-28 .sui-dialog' ).each( function() {
...
( function( $ ) {
	...
	$( '.sui-2-3-28 .sui-notice-top:not(.sui-can-dismiss, .sui-cant-dismiss)' ).delay( 3000 ).slideUp( 'slow' );

	$( '.sui-2-3-28 .sui-notice-dismiss' ).click( function( e ) {
		e.preventDefault();
...
( function( $ ) {
	...
	SUI.showHidePassword = function() {
		...
		$( '.sui-2-3-28 .sui-form-field' ).each( function() {
...
( function( $ ) {
    ...
    $( '.sui-2-3-28 .sui-reviews' ).each( function() {
        var review = $( this );
...
( function( $ ) {
	...
	$( '.sui-2-3-28 .sui-circle-score' ).each( function() {
...
( function( $ ) {
	...
	$( '.sui-2-3-28 select:not([multiple])' ).each( function() {
		SUI.suiSelect( this );
	});
...
( function( $ ) {
	...
	$( '.sui-2-3-28 .sui-side-tabs label.sui-tab-item input' ).each( function() {
		SUI.sideTabs( this );
	});
...
( function( $ ) {
    ...
    if ( 0 !== $( '.sui-2-3-28 .sui-tabs' ).length ) {
        SUI.suiTabs();
    }
...
( function( $ ) {
	...
	if ( 0 !== $( '.sui-2-3-28 .sui-tree' ).length ) {

		$( '.sui-2-3-28 .sui-tree' ).each( function() {
...
( function( $ ) {
	...
	SUI.upload = function() {
		...
		$( '.sui-2-3-28 .sui-upload-group input[type="file"]' ).on( 'change', function( e ) {
