...
(function ($) {
  ...
  if (0 !== $('.sui-2-12-9 .sui-accordion').length) {
    $('.sui-2-12-9 .sui-accordion').each(function () {
...
(function ($) {
  ...
  SUI.suiCodeSnippet = function () {
    ...
    $('.sui-2-12-9 .sui-code-snippet:not(.sui-no-copy)').each(function () {
...
(function ($) {
  ...
  $('.sui-2-12-9 .sui-slider').each(function () {
...
(function ($) {
  ...
  SUI.linkDropdown = function () {
    function closeAllDropdowns($except) {
      var $dropdowns = $('.sui-2-12-9 .sui-dropdown');
    ...
    $('body').on('mouseup', function (e) {
      var $anchor = $('.sui-2-12-9 .sui-dropdown-anchor');
...
(function ($) {
  ...
  SUI.showHidePassword = function () {
    $('.sui-2-12-9 .sui-form-field').each(function () {
      var $this = $(this);
...
(function ($) {
  ...
  $('.sui-2-12-9 .sui-circle-score').each(function () {
...
(function ($) {
  ...
  SUI.select.init = function (select) {
    var getParent = select.closest('.sui-modal-content'),
        ...
        selectParent = getParent.length ? $('#' + getParentId) : $('.sui-2-12-9'),
...
(function ($) {
  ...
  if (0 !== $('.sui-2-12-9 .sui-tabs').length) {
    // Support tabs new markup.
    SUI.tabs(); // Support legacy tabs.

    SUI.suiTabs();
    $('.sui-2-12-9 .sui-tabs-navigation').each(function () {
...
(function ($) {
  ...
  if (0 !== $('.sui-2-12-9 .sui-tree').length) {
    $('.sui-2-12-9 .sui-tree').each(function () {
...
(function ($) {
  ...
  SUI.upload = function () {
    $('.sui-2-12-9 .sui-upload-group input[type="file"]').on('change', function (e) {
    ...
    if ($('.sui-2-12-9 .sui-file-upload').length) {
      // This will trigger on file change. 
      $('.sui-2-12-9 .sui-file-browser input[type="file"]').on('change', function () {
      ...
      $('.sui-2-12-9 .sui-file-browser .sui-upload-button').on('click', function () {
        selectFile($(this));
      }); // This will trigger when user wants to remove the selected upload file

      $('.sui-2-12-9 .sui-file-upload [aria-label="Remove file"]').on('click', function () {
        removeFile($(this));
      }); // This will trigger reupload of file

      $('.sui-2-12-9 .sui-file-browser .sui-upload-image').on('click', function () {
        selectFile($(this));
      ...
      var uploadArea = $('.sui-2-12-9 .sui-upload-button');
