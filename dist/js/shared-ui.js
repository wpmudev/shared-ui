...
( function( $ ) {
	...
	if ( 0 !== $( '.sui-2-3-3 .sui-accordion' ).length ) {

		$( '.sui-2-3-3 .sui-accordion' ).each( function() {
...
( function( $ ) {
    ...
    SUI.suiCodeSnippet = function( ) {
        ...
        $( '.sui-2-3-3 .sui-code-snippet:not(.sui-no-copy)' ).each( function() {
...
( function( $ ) {
	...
	SUI.linkDropdown = function() {
		...
		function closeAllDropdowns( $except ) {
			...
			var $dropdowns = $( '.sui-2-3-3 .sui-dropdown' );
		...
		$( 'body' ).mouseup( function( e ) {
			...
			var $anchor = $( '.sui-2-3-3 .sui-dropdown-anchor' );
...
( function( $ ) {
	...
	$( '.sui-2-3-3 .sui-notice-top:not(.sui-can-dismiss, .sui-cant-dismiss)' ).delay( 3000 ).slideUp( 'slow' );

	$( '.sui-2-3-3 .sui-notice-dismiss' ).click( function( e ) {
		e.preventDefault();
...
( function( $ ) {
	...
	SUI.showHidePassword = function() {
		...
		$( '.sui-2-3-3 .sui-password-group' ).each( function() {
			var $this = $( this ),
...
( function( $ ) {
	...
	$( '.sui-2-3-3 .sui-circle-score' ).each( function() {
...
( function( $ ) {
	...
	$( '.sui-2-3-3 select' ).each( function() {
		SUI.suiSelect( this );
	});
...
( function( $ ) {
    ...
    if ( 0 !== $( '.sui-2-3-3 .sui-tabs' ).length ) {
        SUI.suiTabs();
    }
...
( function( $ ) {
	...
	SUI.upload = function() {
		...
		$( '.sui-2-3-3 .sui-upload-group input[type="file"]' ).on( 'change', function( e ) {
