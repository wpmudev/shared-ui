...
( function( $ ) {
	...
	var accordionTable = $( '.sui-2-0-13 .sui-accordion' );
...
( function( $ ) {
	...
	$( '.sui-2-0-13 .sui-code-snippet:not(.sui-no-copy)' ).each( function( i ) {
...
( function( $ ) {
	...
	SUI.linkDropdown = function() {
		...
		function closeAllDropdowns( $except ) {
			var $dropdowns = $( '.sui-2-0-13 .sui-dropdown' );
...
( function( $ ) {
	...
	$( '.sui-2-0-13 .sui-notice-top:not(.sui-cant-dismiss)' ).delay( 3000 ).slideUp( 'slow' );

	$( '.sui-2-0-13 .sui-notice-dismiss' ).click( function( e ) {
		e.preventDefault();
...
( function( $ ) {
	...
	SUI.showHidePassword = function() {
		...
		$( '.sui-2-0-13 .sui-password-group' ).each( function() {
			var $this = $( this ),
...
( function( $ ) {
	...
	$( '.sui-2-0-13 .sui-circle-score' ).each( function() {
...
( function( $ ) {
	...
	$( '.sui-2-0-13 select' ).each( function() {
		suiSelect( this );
	});
...
( function( $ ) {
	...
	$( '.sui-2-0-13 .sui-tabs' ).each( function() {
		suiTabs( this );
	});
...
( function( $ ) {
	...
	SUI.upload = function() {
		...
		$( '.sui-2-0-13 .sui-upload-group input[type="file"]' ).on( 'change', function( e ) {
