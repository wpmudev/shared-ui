...
(function ($) {
  ...
  if (0 !== $('.sui-2-10-0-beta-2 .sui-accordion').length) {
    $('.sui-2-10-0-beta-2 .sui-accordion').each(function () {
...
(function ($) {
  ...
  SUI.suiCodeSnippet = function () {
    ...
    $('.sui-2-10-0-beta-2 .sui-code-snippet:not(.sui-no-copy)').each(function () {
...
(function ($) {
  ...
  $('.sui-2-10-0-beta-2 .sui-slider').each(function () {
...
(function ($) {
  ...
  SUI.linkDropdown = function () {
    function closeAllDropdowns($except) {
      var $dropdowns = $('.sui-2-10-0-beta-2 .sui-dropdown');
    ...
    $('body').mouseup(function (e) {
      var $anchor = $('.sui-2-10-0-beta-2 .sui-dropdown-anchor');
...
(function ($) {
  ...
  SUI.showHidePassword = function () {
    $('.sui-2-10-0-beta-2 .sui-form-field').each(function () {
      var $this = $(this);
...
(function ($) {
  ...
  $('.sui-2-10-0-beta-2 .sui-reviews').each(function () {
    var review = $(this);
...
(function ($) {
  ...
  $('.sui-2-10-0-beta-2 .sui-circle-score').each(function () {
 ...
 *
 * Modifications should contain a description and be tagged with @edited
  ...
  var S2 = function () {
      ...
      BaseSelection.prototype._attachCloseHandler = function (container) {
        $(document.body).on('mousedown.select2.' + container.id, function (e) {
          ...
          $all.each(function () {
            ...
            var $element = Utils.GetData(this, 'element'); // SUIselect Renamed function. @edited
    ...
    S2.define('select2/selection/single', ['jquery', './base', '../utils', '../keys'], function ($, BaseSelection, Utils, KEYS) {
      ...
      SingleSelection.prototype.render = function () {
        ...
        $selection.addClass('select2-selection--single'); // $selection.html(
    ...
    S2.define('select2/dropdown/attachBody', ['jquery', '../utils'], function ($, Utils) {
      ...
      AttachBody.prototype._positionDropdown = function () {
        var $window = $(window); // var isCurrentlyAbove = this.$dropdown.hasClass('select2-dropdown--above');
    ...
    S2.define('select2/core', ['jquery', './options', './utils', './keys'], function ($, Options, Utils, KEYS) {
      var Select2 = function Select2($element, options) {
        ...
        $element.attr('aria-hidden', 'true'); // Hide the original select with SUI.
      ...
      Select2.prototype.render = function () {
        ...
        this.$container = $container; // Remove select2 theme classname. @edited
    ...
    S2.define('select2/dropdown/attachContainer', [], function () {
      ...
      AttachContainer.prototype.position = function (decorated, $dropdown, $container) {
        ...
        $dropdownContainer.append($dropdown); // $dropdown.addClass( 'select2-dropdown--below' );
    ...
    */
    ...
    S2.define('sui.select', ['jquery', 'jquery-mousewheel', './select2/core', './select2/defaults', './select2/utils'], function ($, _, Select2, Defaults, Utils) {
      // SUIselect renamed function. @edited
      if ($.fn.SUIselect == null) {
        // All methods that should return the element
        var thisMethods = ['open', 'close', 'destroy']; // SUIselect renamed function. @edited
          ...
          if (_typeof(options) === 'object') {
            ...
            this.each(function () {
              ...
              if (instance == null && window.console && console.error) {
                // SUIselect renamed function. @edited
                console.error('The SUIselect(\'' + options + '\') method was called on an ' + 'element that is not using Select2.');
              }
...
(function ($) {
  ...
  $('.sui-2-10-0-beta-2 .sui-side-tabs label.sui-tab-item input').each(function () {
    SUI.sideTabs(this);
  });
})(jQuery);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
(function ($) {
  ...
  if (0 !== $('.sui-2-10-0-beta-2 .sui-tabs').length) {
    // Support tabs new markup.
    SUI.tabs(); // Support legacy tabs.

    SUI.suiTabs();
    $('.sui-2-10-0-beta-2 .sui-tabs-navigation').each(function () {
...
(function ($) {
  ...
  if (0 !== $('.sui-2-10-0-beta-2 .sui-tree').length) {
    $('.sui-2-10-0-beta-2 .sui-tree').each(function () {
...
(function ($) {
  ...
  SUI.upload = function () {
    $('.sui-2-10-0-beta-2 .sui-upload-group input[type="file"]').on('change', function (e) {
