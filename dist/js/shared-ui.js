...
( function( $ ) {
	...
	if ( 0 !== $( '.sui-2-3-10 .sui-accordion' ).length ) {

		$( '.sui-2-3-10 .sui-accordion' ).each( function() {
...
( function( $ ) {
    ...
    SUI.suiCodeSnippet = function( ) {
        ...
        $( '.sui-2-3-10 .sui-code-snippet:not(.sui-no-copy)' ).each( function() {
...
( function( $ ) {
	...
	SUI.linkDropdown = function() {
		...
		function closeAllDropdowns( $except ) {
			...
			var $dropdowns = $( '.sui-2-3-10 .sui-dropdown' );
		...
		$( 'body' ).mouseup( function( e ) {
			...
			var $anchor = $( '.sui-2-3-10 .sui-dropdown-anchor' );
...
( function( $ ) {
	...
	$( '.sui-2-3-10 .sui-notice-top:not(.sui-can-dismiss, .sui-cant-dismiss)' ).delay( 3000 ).slideUp( 'slow' );

	$( '.sui-2-3-10 .sui-notice-dismiss' ).click( function( e ) {
		e.preventDefault();
...
( function( $ ) {
	...
	SUI.showHidePassword = function() {
		...
		$( '.sui-2-3-10 .sui-form-field' ).each( function() {
...
( function( $ ) {
	...
	$( '.sui-2-3-10 .sui-circle-score' ).each( function() {
...
( function( $ ) {
	...
	$( '.sui-2-3-10 select' ).each( function() {
		SUI.suiSelect( this );
	});
...
( function( $ ) {
    ...
    if ( 0 !== $( '.sui-2-3-10 .sui-tabs' ).length ) {
        SUI.suiTabs();
    }
...
( function( $ ) {
	...
	SUI.upload = function() {
		...
		$( '.sui-2-3-10 .sui-upload-group input[type="file"]' ).on( 'change', function( e ) {
