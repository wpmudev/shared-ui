...
!function (e, t) {
  ...
  return function e() {
    ...
    var it = function it(e) {
      ...
      if (t.removeAttribute(e), "is" === e && !we[e]) if (Fe || Ie) try {
        at(t);
      } catch (e) {} else try {
        t.setAttribute(e, "");
      } catch (e) {}
      ...
      if (a) {
        ...
        for (i = a.length; i--;) {
          var c = t = a[i],
              s = c.name,
              u = c.namespaceURI;
          if (r = b(t.value), o = g(s), l.attrName = o, l.attrValue = r, l.keepAttr = !0, l.forceKeepAttr = void 0, mt("uponSanitizeAttribute", e, l), r = l.attrValue, !l.forceKeepAttr && (lt(s, e), l.keepAttr)) if (A(/\/>/i, r)) lt(s, e);else {
    ...
    return n.sanitize = function (e, o) {
      ...
      if (Me || et(o), n.removed = [], "string" == typeof e && (je = !1), je) ;else if (e instanceof c) 1 === (l = (i = ct("\x3c!----\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === l.nodeName || "HTML" === l.nodeName ? i = l : i.appendChild(l);else {
      ...
      if (Fe) {
        if (Ie) for (f = se.call(i.ownerDocument); i.firstChild;) {
